...
hdfs_output_path = "hdfs://master:9000/output/project_similarity"  # HDFS path
ck_path = "hdfs://master:9000/checkpoint/project_similarity" 
es_host = "<your-es-ip>"
es_port = "<your-es-port>"
es_index = "project_similarity_time"  # Elasticsearch index name
...
def main():
    ...
    query_es = events_df \
        ...
        .option("checkpointLocation", "hdfs://master:9000/checkpoint/project_similarity") \
        .start()
