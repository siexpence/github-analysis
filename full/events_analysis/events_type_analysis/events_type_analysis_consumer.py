...
kafka_topic = "events_list_all"  # 修改为对应的topic
hdfs_output_path = "hdfs://master:9000/output/event_type"  # 需要修改 Replace with your HDFS path
ck_path = "hdfs://master:9000/checkpoint/event_type"  # 需要修改
es_host = "<your-es-ip>"
es_port = "<your-es-port>"
es_index = "event_type_time"  # 需要更改  Replace with your desired Elasticsearch index name
...
def main():
    ...
    query_es = events_df \
        ...
        .option("checkpointLocation", "hdfs://master:9000/checkpoint/event_type") \
        .start()
